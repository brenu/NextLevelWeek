...
/**
   PAra uma atualização futura que pretendo realizar
...
const CreatePoint = () => {
    ...
    const [ initialPosition, setInitialPosition ] = useState<[number, number]>([-15.700491, -37.518541]);
        ...
        <div id="page-create-point">
            ...
            { createState === true && (
                <div className="alert-container">
                    <FiCheckCircle id="alert-icon" size={72} color="#34CB79" />
                    <p className="alert-text">Cadastro concluído!</p>
                </div>
            )}
        </div>
    );
